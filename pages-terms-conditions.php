...
<head>
    <meta charset="utf-8" />
    <title>Terms & Conditions | Campus Coach - Shape Your Future with Confidence</title>
        ...
        <div class="page-content">
            ...
            <div class="page-container">
                        ...
                        <div class="row">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ol class="ps-3 d-flex flex-column gap-1">
                                            <li>
                                                <p class="mb-0"><span class="text-dark fw-semibold">Email : </span> <a href="#!">ocenbyEndeavour Digital@mail.com</a></p>
                                            </li>
                                            <li>
                                                <p class="mb-0"><span class="text-dark fw-semibold">Contact Number : </span> <a href="#!">+001 364-364-000</a></p>
                                            </li>
                                            <li>
                                                <p class="mb-0"><span class="text-dark fw-semibold">Location : </span> <a href="#!">3469 Beech Street Oakland, CA 94607</a></p>
                                            </li>
                                        </ol>
                            ...
                            <div class="col-xl-6 col-lg-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="mb-1">Endeavour Digital will not be liable for any damages arising from the use or inability to use our website or services. This includes direct, indirect, incidental, or consequential damages.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row justify-content-end text-end mb-3">
                    <div class="col-lg-6">
                        <a href="#!" class="btn btn-dark">Not, Right Now</a>
                        <a href="#!" class="btn btn-secondary ms-1">I Agree With Terms</a>
                    </div>
                </div>
