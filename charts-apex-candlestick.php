...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Apex Candlestick Charts | Campus Coach - Shape Your Future with Confidence</title>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="simple-candlestick" class="apex-charts" data-colors="#6ac75a,#fa5c7c"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="combo-candlestick" class="apex-charts" data-colors="#6ac75a,#fa5c7c"></div>
                                            <div id="combo-bar-candlestick" class="apex-charts" data-colors="#ce7e7e,#ffbc00"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="x-axis-candlestick" class="apex-charts" data-colors="#6ac75a,#fa5c7c,#ce7e7e"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="candlestick-with-line" class="apex-charts" data-colors="#ce7e7e,#6ac75a,#fa5c7c"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
