...
<head>
    <meta charset="utf-8" />
    <title>Order Details | Campus Coach - Shape Your Future with Confidence</title>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="avatar-lg bg-light d-flex align-items-center justify-content-center rounded  flex-shrink-0">
                                        <img src="assets/images/cards/mastercard.svg" alt="Card Img" class="img-fluid">
                                    </div>
                                    <div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap align-items-center mt-3 mb-2 justify-content-between gap-2">
                                    ...
                                    <div>
                                        <span class="badge bg-light-subtle rounded-pill text-dark border fs-13 fw-medium py-1 px-2 d-flex align-items-center gap-1"><iconify-icon icon="solar:map-point-bold-duotone" class="fs-18 text-warning"></iconify-icon> 1890 Uitsig St Grahamstad USA</span>
                                    </div>
                                </div>
                ...
                <div class="row">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <p class="mb-0 fs-14 fw-medium text-muted">Endeavour Digital <iconify-icon icon="solar:verified-check-bold" class="align-middle text-success"></iconify-icon></p>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center gap-2">
                                    <div class="avatar-lg bg-light d-flex align-items-center justify-content-center rounded">
                                        <img src="assets/images/brands/digital-ocean.svg" alt="" class="avatar-md">
                                    </div>
                                ...
                                <div class="row justify-content-between mt-4">
                                    ...
                                    <div class="col-lg-7">
                                        ...
                                        <span class="badge bg-light-subtle rounded-pill text-dark border fs-13 fw-medium py-1 px-2 ">#PY26356-NT <a href="#!" class="ms-1"><i class="ti ti-copy"></i></a></span>
                                    </div>
                    ...
                    <div class="col-xl-4 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="mapouter">
                                    <div class="gmap_canvas"><iframe class="gmap_iframe rounded" width="100%" style="height: 264px;" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=1980&amp;height=400&amp;hl=en&amp;q=University of Oxford&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe></div>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-lg-6">
                                        <div class="d-flex align-items-center border border-dashed rounded p-2 gap-3">
                                            <div class="rounded bg-light avatar-xl d-flex align-items-center justify-content-center">
                                                <img src="assets/images/products/p-3.png" alt="" class="avatar-xl">
                                            </div>
                                            <div>
                                                <a href="#!" class="text-dark fw-medium fs-15">Minetta Rattan Swivel Luxury Green Lounge Chair</a>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="d-flex align-items-center border border-dashed rounded p-2 gap-3">
                                            ...
                                            <div>
                                                <a href="#!" class="text-dark fw-medium fs-15">Jordan Jumpman MVP Men's Shoes Size</a>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="d-flex align-items-center border border-dashed rounded p-2 gap-3">
                                            <div class="rounded bg-light avatar-xl d-flex align-items-center justify-content-center">
                                                <img src="assets/images/products/p-4.png" alt="" class="avatar-xl">
                                            </div>
                                            <div>
