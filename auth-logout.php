...
<head>
    <meta charset="utf-8" />
    <title>Log Out | Campus Coach - Shape Your Future with Confidence</title>
                ...
                <div class="card overflow-hidden text-center h-100 p-xxl-4 p-3 mb-0">
                    ...
                    <div class="d-flex align-items-center gap-2 mb-3 text-start">
                        ...
                        <div>
                            ...
                            <p class="mb-0">Thank you for using Campus Coach Admin</p>
                        </div>
                    </div>
                    ...
                    <p class="text-danger fs-14 my-3">Back to <a href="auth-login.php" class="text-dark fw-semibold ms-1">Login !</a>
