...
<head>
    <meta charset="utf-8" />
    <title>Fullscreen Layout | Campus Coach - Shape Your Future with Confidence</title>
            ...
            <div class="page-container">
                ...
                <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
                    <div class="flex-grow-1">
                        <h4 class="fs-18 text-uppercase fw-bold mb-0">Fullscreen</h4>
                    </div>
                    ...
                    <div class="text-end">
                        <ol class="breadcrumb m-0 py-0">
                            ...
                            <li class="breadcrumb-item active">Fullscreen</li>
                        </ol>
                    </div>
                </div>
