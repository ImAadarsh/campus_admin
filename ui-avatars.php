...
<head>
    <meta charset="utf-8" />
    <title>Avatars | Campus Coach - Shape Your Future with Confidence</title>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3">
                                        <!-- Default Group (Soft) -->
                                        <div class="avatar-group">
                                            <div class="avatar" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-secondary" data-bs-placement="top" title="Vicki">
                                            ...
                                            <div class="avatar" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-warning" data-bs-placement="top" title="Kevin">
                                                <img src="assets/images/users/avatar-7.jpg" alt="" class="rounded-circle avatar-sm">
                                            </div>
                                            <div class="avatar" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-info" data-bs-placement="top" title="Chris">
                                                <img src="assets/images/users/avatar-1.jpg" alt="" class="rounded-circle avatar-sm">
                                            </div>
                                            <div class="avatar avatar-sm" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-danger" data-bs-placement="top" title="15 more Users">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2 text-center">
                                        <img src="assets/images/users/avatar-2.jpg" alt="image" class="img-fluid rounded" width="120" />
                                        <p class="mb-0">
                                            <code>.rounded</code>
                                        </p>
                                    </div>
                                    ...
                                    <div class="col-sm-2">
                                        <img src="assets/images/small/small-1.jpg" alt="image" class="img-fluid img-thumbnail" width="200" />
                                        <p class="mb-0">
