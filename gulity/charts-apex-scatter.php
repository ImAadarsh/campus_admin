...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Apex Scatter Charts | Campus Coach - Shape Your Future with Confidence</title>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="basic-scatter" class="apex-charts" data-colors="#39afd1,#ffbc00,#ce7e7e"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="datetime-scatter" class="apex-charts" data-colors="#6c757d,#ffbc00,#ce7e7e,#6ac75a,#fa5c7c"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
