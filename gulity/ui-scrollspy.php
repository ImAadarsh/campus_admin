...
<head>
    <meta charset="utf-8" />
    <title>Scrollspy | Campus Coach - Shape Your Future with Confidence</title>
                        ...
                        <nav id="navbar-example2" class="navbar navbar-light bg-light px-3">
                            ...
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Dropdown <i class="ti ti-chevron-down"></i></a>
                                    <div class="dropdown-menu dropdown-menu-end">
