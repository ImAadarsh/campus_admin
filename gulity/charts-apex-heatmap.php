...
<head>
    <meta charset="utf-8" />
    <title>Apex Heatmap Charts | Campus Coach - Shape Your Future with Confidence</title>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="basic-heatmap" class="apex-charts" data-colors="#ce7e7e"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="color-range-heatmap" class="apex-charts" data-colors="#fa5c7c,#ffbc00,#39afd1,#6ac75a"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="rounded-heatmap" class="apex-charts" data-colors="#6ac75a,#ffbc00"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
