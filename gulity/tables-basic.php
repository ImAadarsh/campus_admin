...
<head>
    <meta charset="utf-8" />
    <title>Basic Tables | Campus Coach - Shape Your Future with Confidence</title>
                                ...
                                <div class="table-responsive-sm">
                                    <table class="table table-bordered mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="assets/images/users/avatar-7.jpg" alt="table-user" class="avatar-sm me-2 rounded-circle" />
                                                    Ann C. Thompson
                                                </td>
                                                <td>SB646 473 2057</td>
                                                <td>January 25, 1959</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="assets/images/users/avatar-8.jpg" alt="table-user" class="avatar-sm me-2 rounded-circle" />
                                                    Paul J. Friend
                                                </td>
                                                <td>DL281 308 0793</td>
                                                <td>September 1, 1939</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="assets/images/users/avatar-9.jpg" alt="table-user" class="avatar-sm me-2 rounded-circle" />
                                                    Sean C. Nguyen
                                                </td>
                                                <td>CA269 714 6825</td>
                                                <td>February 5, 1994</td>
