...
<head>
    <meta charset="utf-8" />
    <title>Products | Campus Coach - Shape Your Future with Confidence</title>
                        ...
                        <div class="card">
                            <div class="card-header border-bottom">
                                <div class="d-flex flex-wrap justify-content-between gap-2">
                                    ...
                                    <div>
                                        <a href="apps-ecommerce-products-add.php" class="btn btn-primary"><i class="ti ti-plus me-1"></i>Add Products</a>
                                    </div>
                                </div>
                            </div>
