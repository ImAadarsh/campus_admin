...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Apex Sparklines Charts | Campus Coach - Shape Your Future with Confidence</title>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row" dir="ltr">
                                            <div class="col-md-4">
                                                <div id="spark1" class="apex-charts" data-colors="#ce7e7e"></div>
                                            </div>
                                            <div class="col-md-4">
                                                <div id="spark2" class="apex-charts" data-colors="#ffbc00"></div>
                                            </div>
                                            <div class="col-md-4">
                                                <div id="spark3" class="apex-charts" data-colors="#6ac75a"></div>
                                            </div>
                                        </div>
                                        <!-- end row -->
                                                ...
                                                <table class="table mb-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>15%</td>
                                                            <td>
                                                                <div id="chart1" data-colors="#ce7e7e"></div>
                                                            </td>
                                                            <td>
                                                                <div id="chart5" data-colors="#ce7e7e"></div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>7%</td>
                                                            <td>
                                                                <div id="chart2" data-colors="#6ac75a"></div>
                                                            </td>
                                                            <td>
                                                                <div id="chart6" data-colors="#6ac75a"></div>
                                                            </td>
                                                        </tr>
                                                        <tr>
