...
<body>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap gap-2 align-items-center">
                                    <div class="avatar-xl bg-light d-flex align-items-center justify-content-center rounded-circle flex-shrink-0">
                                        <img src="assets/images/sellers/s-1.svg" alt="" class="avatar-lg flex-shrink-0">
                                    </div>
                                    <div>
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-wrap gap-2 align-items-center">
                                    <div class="avatar-xl bg-light d-flex align-items-center justify-content-center rounded-circle flex-shrink-0">
                                        <img src="assets/images/sellers/s-4.svg" alt="" class="avatar-lg flex-shrink-0">
                                    </div>
                                    <div>
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-wrap gap-2 align-items-center">
                                    <div class="avatar-xl bg-light d-flex align-items-center justify-content-center rounded-circle flex-shrink-0">
                                        <img src="assets/images/sellers/s-6.svg" alt="" class="avatar-lg flex-shrink-0">
                                    </div>
                                    <div>
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-wrap gap-2 align-items-center">
                                    <div class="avatar-xl bg-light d-flex align-items-center justify-content-center rounded-circle flex-shrink-0">
                                        <img src="assets/images/sellers/s-7.svg" alt="" class="avatar-lg flex-shrink-0">
                                    </div>
                                    <div>
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-wrap gap-2 align-items-center">
                                    <div class="avatar-xl bg-light d-flex align-items-center justify-content-center rounded-circle flex-shrink-0">
                                        <img src="assets/images/sellers/s-8.svg" alt="" class="flex-shrink-0" height="20" width="60">
                                    </div>
                                    <div>
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-wrap gap-2 align-items-center">
                                    <div class="avatar-xl bg-light d-flex align-items-center justify-content-center rounded-circle flex-shrink-0">
                                        <img src="assets/images/sellers/s-2.svg" alt="" class="flex-shrink-0" height="30" width="70">
                                    </div>
                                    <div>
    ...
    <!-- Sellers Demo App js -->
    <script src="assets/js/pages/sellers.js"></script>
