...
<head>
    <meta charset="utf-8" />
    <title>Apex Area Chart | Campus Coach - Shape Your Future with Confidence</title>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="basic-area" class="apex-charts" data-colors="#f28888"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="spline-area" class="apex-charts" data-colors="#ce7e7e,#6c757d"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="area-chart-negative" class="apex-charts" data-colors="#6ac75a,#ffbc00"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                                ...
                                <div dir="ltr">
                                    ...
                                    <div class="pt-2 pb-2">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col ps-0">
                                                <a href="javascript:void(0);" class="text-muted fw-bold">Endeavour Digital</a>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="stacked-area" class="apex-charts" data-colors="#ce7e7e,#6ac75a,#e3eaef"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="area-timeSeries" class="apex-charts" data-colors="#f8b0f9,#ce7e7e,#669776"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="area-chart-nullvalues" class="apex-charts" data-colors="#669776"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
