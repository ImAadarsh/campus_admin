...
<head>
    <meta charset="utf-8" />
    <title>Apex Timeline Chart | Campus Coach - Shape Your Future with Confidence</title>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="basic-timeline" class="apex-charts" data-colors="#f28888"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="distributed-timeline" class="apex-charts" data-colors="#ce7e7e,#6ac75a,#fa5c7c,#6c757d,#39afd1"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="advanced-timeline" class="apex-charts" data-colors="#ce7e7e,#6ac75a,#fa5c7c"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="group-rows-timeline" class="apex-charts" data-colors="#ce7e7e,#6ac75a,#fa5c7c,#6c757d,#39afd1,#ffc35a, #eef2f7, #313a46,#3577f1, #0ab39c, #f0a548,#68eaff"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
