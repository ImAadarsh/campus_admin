...
<head>
    <meta charset="utf-8" />
    <title>Dropdowns | Campus Coach - Shape Your Future with Confidence</title>
                                    ...
                                    <div class="col-auto">
                                        <div class="dropdown">
                                            <button class="btn btn-soft-success dropdown-toggle drop-arrow-none" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                Solar Icon <iconify-icon icon="solar:album-bold-duotone" class="fs-20 ms-2"></iconify-icon>
                                            </button>
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="#">Action</a>
                                                <a class="dropdown-item" href="#">Another action</a>
