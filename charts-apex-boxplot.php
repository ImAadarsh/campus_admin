...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Apex Boxplot Chart | Campus Coach - Shape Your Future with Confidence</title>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="basic-boxplot" class="apex-charts" data-colors="#ce7e7e,#6ac75a"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="horizontal-boxplot" class="apex-charts" data-colors="#ce7e7e,#6ac75a,#e3eaef"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
