...
<head>
    <meta charset="utf-8" />
    <title>Apex Column Charts | Campus Coach - Shape Your Future with Confidence</title>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="basic-column" class="apex-charts" data-colors="#ce7e7e,#6ac75a,#fa5c7c"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="datalabels-column" class="apex-charts" data-colors="#ce7e7e"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="full-stacked-column" class="apex-charts" data-colors="#39afd1,#6ac75a,#e3eaef"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="column-with-markers" class="apex-charts" data-colors="#ce7e7e,#ffbc00"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="column-with-group-label" class="apex-charts" data-colors="#39afd1,#6ac75a,#e3eaef"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="negative-value-column" class="apex-charts" data-colors="#ce7e7e"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="distributed-column" class="apex-charts" data-colors="#ce7e7e,#6c757d,#6ac75a,#fa5c7c,#ffbc00,#39afd1,#e3eaef,#313a46"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="range-column" class="apex-charts" data-colors="#6ac75a,#39afd1"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div dir="ltr">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div id="chart-year" data-colors="#ce7e7e,#6c757d,#6ac75a,#fa5c7c,#ffbc00,#39afd1"></div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div id="chart-quarter" data-colors="#ce7e7e,#6c757d,#6ac75a,#fa5c7c,#ffbc00,#39afd1"></div>
                                        </div>
                                    </div> <!-- end row-->
                                </div>
                            </div>
